    ...
    <div class="container">
        ...
        <div class="row mt-3">
            <div v-for="produto in produtos" :key="produto.id">
                <Card>
                    <template v-slot:nome>{{ produto.nome }}
                    </template>
                    ...
                    <template v-slot:acoes>
                        <i @click="editarProduto(produto)" class="fas fa-pencil-alt icones-tabela"></i>
                        <i @click="excluirProduto(produto)" class="fas fa-trash-alt icones-tabela"></i>
                    </template>
                </Card>
            </div>
        </div>
